...
def main():
    ...
    while True:
        time.sleep(0.3)
        print('Enter your command, I know only 9 commands: hello, add, add birthday, change phone, remove phone, show all, good bye, close, exit:')
...
if __name__ == '__main__':
    ...
    COMMANDS = {'hello': hello, 'add birthday': add_name_birthday, 'add': add_name_phone,
                'change phone': change_phone, 'remove phone': remove_phone,
